...
[System.Serializable]
public class GameDesign_SpringAnimals : EditorWindow
{
    ...
    {
        GameDesign_SpringAnimals window = EditorWindow.GetWindow<GameDesign_SpringAnimals>(true, "GAME DESIGN");
    ...
    void OnEnable()
    {
        ...
        vars = (ManageVariables)AssetDatabase.LoadAssetAtPath("Assets/Spring Animals/Resources/ManageVariablesContainer.asset", typeof(ManageVariables));
