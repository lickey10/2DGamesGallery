...
/// </summary>
public class GameManager_SpringAnimals : MonoBehaviour
{
    public static GameManager_SpringAnimals instance;

    private GameData_SpringAnimals data;
    ...
    void InitializeVariables()
    {
        ...
        if (isGameStartedFirstTime)
        {
            ...
            data = new GameData_SpringAnimals();
    ...
    public void Load()
    {
        ...
        try
        {
            ...
            data = (GameData_SpringAnimals)bf.Deserialize(file);
        }
        catch (Exception e) { }
        finally
        {
