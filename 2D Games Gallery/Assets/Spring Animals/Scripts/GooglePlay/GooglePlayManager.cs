...
public class GooglePlayManager_SpringAnimals : MonoBehaviour
{

    public static GooglePlayManager_SpringAnimals singleton;
    ...
    {
        ReportScore(GameManager_SpringAnimals.instance.lastScore);
    }
