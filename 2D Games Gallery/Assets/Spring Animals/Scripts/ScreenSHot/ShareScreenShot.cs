...
public class ShareScreenShot_SpringAnimals : MonoBehaviour
{
    public static ShareScreenShot_SpringAnimals instance;
    ...
    {
        shareScore = "" + GameManager_SpringAnimals.instance.lastScore;
