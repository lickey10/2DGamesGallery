...
public class SpawnerController : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        if (GameManager_SpringAnimals.instance.isGameOver == false)
        {
            SelectAnimal();
        }
    ...
    IEnumerator WaitForNextSpawn()
    {
        ...
        if (GameManager_SpringAnimals.instance.currentScore <= 10)
        {
            timeVal = time;
        }
        else if (GameManager_SpringAnimals.instance.currentScore > 10 /*&& GameManager.instance.currentScore <= 15*/)
        {
    ...
    void IncreaseDiff()
    {
        if (GameManager_SpringAnimals.instance.currentScore > timeMileStoneCount)
        {
            timeMileStoneCount += timeDecreaseMileStone;
