...
public class EnemyLevelSpawner : MonoBehaviour {
    ...
    public void SpawnLevel()
    {
        ...
        if (r == 0)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom1();
        else if (r == 1)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom2();
        else if (r == 2)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom3();
        else if (r == 3)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom4();
        else if (r == 4)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom5();
        else if (r == 5)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom6();
        else if (r == 6)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom7();
        else if (r == 7)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom8();
        else if (r == 8)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom9();
        else if (r == 9)
            enemyLevel = ObjectPooling_AlienHop.instance.GetPlatfrom10();
