...
public class PlayerControl : MonoBehaviour {
    ...
    {   //if game is over
        ...
        {   //jump sound is played
            ...
            GameManager_AlienHop.instance.currentScore++; //score is increased by 1
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("PickUp"))//if its the pickup
        {
            ...
            GameManager_AlienHop.instance.currentPoints++;//increase the current point
            GameManager_AlienHop.instance.points++; //increase the points
    ...
    {   //we set the close eye sprite
        mySprite.sprite = vars.characters[GameManager_AlienHop.instance.selectedSkin].gameCharacterSprite2;
        yield return new WaitForSeconds(0.25f);//after 0.25f sec
        //we set the open eye sprite
        mySprite.sprite = vars.characters[GameManager_AlienHop.instance.selectedSkin].gameCharacterSprite1;
    ...
    IEnumerator Death()//death coroutine
    {
        ...
        GameManager_AlienHop.instance.gameOver = true;//game over is true
        GameObject deathEffect = ObjectPooling_AlienHop.instance.GetDeathEffect();//death effect
