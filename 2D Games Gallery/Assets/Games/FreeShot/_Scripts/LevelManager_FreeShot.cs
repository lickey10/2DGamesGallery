...
/// </summary>
public class LevelManager_FreeShot : Singleton_FreeShot<LevelManager_FreeShot> 
{
	public List<Level> levels;

	void Awake(){
		int level = PlayerPrefs.GetInt (Constant_FreeShot.LAST_LEVEL_PLAYED);
		if (level > 1200) {
			PlayerPrefs.SetInt (Constant_FreeShot.LAST_LEVEL_PLAYED, 1200);
		}
	}
...
public class Level
{
	...
	public Level (int level)
	{
		...
		if (level > maxLevel) 
		{
			PlayerPrefs.SetInt (Constant_FreeShot.LEVEL_UNLOCKED, 1200);
